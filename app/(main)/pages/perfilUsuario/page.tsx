...
import { PerfilUsuarioService } from '@/service/PerfilUsuario';
...
const PerfilUsuario = () => {
    ...
    const perfilDialogContent = (
        <div>
            <div className="field">
                <label htmlFor="descricao">Descrição</label>
                <InputText
                    id="descricao"
                    value={perfilUsuario.perfil.descricao}
                    onChange={(e) => onInputChange(e, 'perfil.descricao')}
                    required
                    autoFocus
                    className={classNames({ 'p-invalid': submitted && !perfilUsuario.perfil.descricao })}
                />
                {submitted && !perfilUsuario.perfil.descricao && <small className="p-error">Descrição é obrigatória.</small>}
            </div>
            {/* Outros campos de entrada para usuário e perfil */}
        </div>
    );
